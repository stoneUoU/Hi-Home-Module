...
class HiUnSignTableViewCell: UITableViewCell {
    ...
    lazy var excuteButton:UIButton = {[weak self] in
        ...
        excuteButton.layer.borderColor = HiColorLightBlueView.cgColor;
        excuteButton.setTitleColor(HiColorLightBlueView, for: .normal)
        excuteButton.tag = 0;
        excuteButton.setTitle("去签约", for: .normal)
...
extension HiUnSignTableViewCell {
